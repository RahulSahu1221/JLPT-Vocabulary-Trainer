...
async function toggleTheme(forceTheme) {
    ...
    const reduceMotion = store.get("jlpt_settings_reduceMotion", false) || window.matchMedia('(prefers-reduced-motion: reduce)').matches;

    let shutter = document.querySelector('.theme-shutter');
